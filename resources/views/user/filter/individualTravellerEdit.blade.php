        ...
        {{ Form::open(array('url' => "/userinfo/".$aUserData["username"]."/update", 'method' => 'post')) }}
            <div class="row padding-10 pt-0">
                <div class="col color-dark-blue">
                    <h4><u>Algemeen</u></h4>
                    <label class="col-4 font-weight-bold" for="LastName">Naam:              </label>    <input id="LastName"     name="LastName"     required class="col-6" type="text" value="{{$aUserData["last_name"]}}">   <br/>
                    <label class="col-4 font-weight-bold" for="FirstName">Voornaam:         </label>    <input id="FirstName"    name="FirstName"    required class="col-6" type="text" value="{{$aUserData["first_name"]}}">  <br/>
                    <label class="col-4 font-weight-bold" for="Gender">Geslacht:            </label>    <input id="Gender"       name="Gender"       required class="" type="radio" value="Man" @if($aUserData["gender"] == "Man") checked @endif>Man <input name="Gender" class="" type="radio" value="Vrouw" @if($aUserData["gender"] == "Vrouw") checked @endif>Vrouw <input name="Gender" class="" type="radio" value="Andere" @if($aUserData["gender"] == "Andere") checked @endif>Andere <br/>
                    <label class="col-4 font-weight-bold" for="Study">Klas:                 </label>    <select id="Study"       name="Study"        required class="col-6 cascadingMajor" data-dependent="Major">
                    ...
                    <label class="col-4 font-weight-bold" for="Major">Afstudeerrichting:   </label>     <select id="Major"       name="Major"        required class="col-6">
                    ...
                    <label class="col-4 font-weight-bold" for="Trip">Reis:                  </label>    <select id="Trip"        name="Trip"         required class="col-6">
                    ...
                    <label class="col-4 font-weight-bold" for="IBAN">IBAN:                  </label>    <input id="IBAN"         name="IBAN"         required class="col-6" type="text" value="{{$aUserData['iban']}}">        <br/>
                    <h4><u>Medisch</u></h4>
                    <label class="col-4 font-weight-bold" for="MedicalIssue">Behandeling:   </label>    <input id="MedicalIssue" name="MedicalIssue" required class="" type="radio" value="1" @if($aUserData["medical_issue"] == "1") checked @endif>Ja <input name="MedicalIssue" type="radio" value="0" @if($aUserData["medical_issue"] == "0") checked @endif>Nee <br/>
                ...
                <div class="col color-dark-blue">
                    <h4><u>Geboorte</u></h4>
                    <label class="col-4 font-weight-bold" for="BirthDate">Geboortedatum:    </label>    {{ Form::date('BirthDate', $aUserData["birthdate"], ['required', 'id'=>'BirthDate','oninput'=>'this.className','type'=>'date', 'class' => 'col-6'])}}   <br/>
                    <label class="col-4 font-weight-bold" for="Birthplace">Geboorteplaats:  </label>    <input id="Birthplace"   name="Birthplace"   required class="col-6" type="text" value="{{$aUserData['birthplace']}}">  <br/>
                    <label class="col-4 font-weight-bold" for="Nationality">Nationaliteit:  </label>    <input id="Nationality"  name="Nationality"  required class="col-6" type="text" value="{{$aUserData['nationality']}}"> <br/>
                    <h4><u>Woonplaats</u></h4>
                    <label class="col-4 font-weight-bold" for="Address">Adres:              </label>    <input id="Address"      name="Address"      required class="col-6" type="text" value="{{$aUserData['address']}}">     <br/>
                    <label class="col-4 font-weight-bold" for="City">Gemeente:              </label>    <select id="City"        name="City"         required class="col-6">
