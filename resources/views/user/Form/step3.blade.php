...
<div class="container bg-white rounded shadow-sm">
    ...
    <div class="form-row border-bottom pt-2">
        <div class="form-group col-md-8">
            ...
            {{ Form::email('txtEmail', $traveller['first_name'] . '.' . str_replace(' ', '', $traveller['last_name']) . '@student.ucll.be', ['required', 'disabled','id'=>'txtEmail','oninput'=>'this.className', 'class' => 'mb-2 form-control '])}}
            @else
                {{ Form::email('txtEmail', $traveller['first_name'] . '.' . str_replace(' ', '', $traveller['last_name']) . '@ucll.be', ['required', 'disabled', 'id'=>'txtEmail','oninput'=>'this.className', 'class' => 'mb-2 form-control '])}}
            @endif
        </div>
